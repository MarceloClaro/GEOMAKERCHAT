...
def upload_data():
    """
    Permite aos usuários fazer upload de arquivos JSON e CSV.
    """
...
def main():
    ...
    # Check if there is already a prompt in session state, otherwise set the primary prompt
    ...
    if user_question:
        ...
        st.session_state.last_prompt = current_prompt  # Update the last prompt in session state
        ...
        show_data_visualizations(upload_data())  # Display visualizations automatically after data is processed
